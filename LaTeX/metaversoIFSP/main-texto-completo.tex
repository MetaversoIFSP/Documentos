...
% Para facilitar a manutenção é shttps://www.overleaf.com/project/627086c1f6b8480b7ae2a874#empre melhore criar um arquivo por capitulo, para exemplo isso não é necessário 
%\input{textos-desenvolvimento}
\input{textos-gerenciamento-projeto}
\input{LaTeX/metaversoIFSP/texto-desenho-aplicacao}
\input{textos-desenvolvimento-metaverso}
\input{LaTeX/metaversoIFSP/texto-tecnologias}
\input{LaTeX/metaversoIFSP/texto-ferramentas}
\input{LaTeX/metaversoIFSP/texto-analise-mercado}
\input{LaTeX/metaversoIFSP/texto-modelo-negocio}
